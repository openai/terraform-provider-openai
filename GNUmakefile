...
ACC_TEST_RESOURCES_RE ?= ^TestAcc(Certificate|Group|GroupRole|GroupUser|Invite|OrganizationDataRetention|OrganizationSpendAlert|OrganizationUser|Project|ProjectGroup|ProjectGroupRole|ProjectModelPermissions|ProjectRateLimit|ProjectRole|ProjectSpendAlert|ProjectUser|ProjectUserRole|UserRole|WebhookEndpoint)_
...
generate:
	...
	cd tools; GOWORK=off go generate -mod=readonly ./...
